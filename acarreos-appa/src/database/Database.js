...
const Database = [
  ...
  {role:'transport', id: 2, username: 'Appa', email: 'katara@water.com', nationality: 'Tribu Agua del Sur', password: 'WaterBending4Life!', location: 'Tribu Agua del Sur'},
  ...
  // Exportar la base de datos para ser usada en otros archivos
